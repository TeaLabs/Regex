...
class RegularExpressionTest extends TestCase
{
	...
	{
		return RegularExpression::parse($pattern);
	}


	protected function cast($pattern)
	{
		return $pattern instanceof RegularExpression ? $pattern : RegularExpression::parse($pattern);
	}
...
// 	{
// 		$r = Adapter::split($pattern, $subject, $limit, $flags);
// 		$r = json_encode($r, JSON_FORCE_OBJECT | JSON_PRETTY_PRINT);
// 		echo "\n {$r}\n";
// 	}
}
